...
//  }
  ...
  public void event() throws InterruptedException {
   ...
   // driver.findElement(By.xpath=//div[contains(text(),'+ New Tournament')])).click();
    ...
    driver.findElement(By.cssSelector(".event-input")).sendKeys("Avp Volleyball1");
    driver.findElement(By.id("exampleFormControlTextarea1")).click();
    driver.findElement(By.id("exampleFormControlTextarea1")).sendKeys("Kho-Kho");
    Thread.sleep(2000);
...
//    
    ...
    driver.findElement(By.id("//*[@id=\"score-hamburger\"]/div/img")).click();
